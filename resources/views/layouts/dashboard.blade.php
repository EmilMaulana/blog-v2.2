...
<body class="g-sidenav-show   bg-gray-100 badan">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="/dashboard">
        ...
        <span class="ms-1 font-weight-bold">Teknik Rekayasa</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="/dashboard/artikel-saya">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link " href="/dashboard/artikel/tambah">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-credit-card text-success text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Tambah Artikel</span>
          </a>
        </li>
        @can('admin')   
          <li class="nav-item">
            <a class="nav-link " href="/dashboard/album">
              ...
              <span class="nav-link-text ms-1">Tambah Gambar</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="/dashboard/categories">
              <div class="border-radius-md text-center me-3 d-flex align-items-center justify-content-center ms-2">
